...
help:
	@echo "KuanaData — available targets:"
	@echo ""
	@echo "  Setup"
...
#   make s3 https://kuana-data.fra1.digitaloceanspaces.com/.../foo.json
#   make s3 URL=https://kuana-data.fra1.cdn.digitaloceanspaces.com/...
