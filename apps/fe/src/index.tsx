import './index.css';
// Side-effect import: configures the impact-cocoa-client SDK (baseUrl +
...
const DashboardPage = lazyRoute(() => import('./features/dashboard/pages/dashboard-page'), 'DashboardPage', '/'); // prettier-ignore
const FarmersPage = lazyRoute(() => import('./features/farmers/pages/farmers-page'), 'FarmersPage', '/farmers'); // prettier-ignore
const FarmerDetailPage = lazyRoute(() => import('./features/farmers/pages/farmer-detail-page'), 'FarmerDetailPage'); // prettier-ignore
const FarmsPage = lazyRoute(() => import('./features/farms/pages/farms-page'), 'FarmsPage', '/farms'); // prettier-ignore
const FarmMapPage = lazyRoute(() => import('./features/farm-map/pages/farm-map-page'), 'FarmMapPage'); // prettier-ignore
const FarmDetailPage = lazyRoute(() => import('./features/farms/pages/farm-detail-page'), 'FarmDetailPage'); // prettier-ignore
const ClmrsPage = lazyRoute(() => import('./features/clmrs/pages/clmrs-page'), 'ClmrsPage', '/clmrs'); // prettier-ignore
const ClmrsRecordDetailPage = lazyRoute(() => import('./features/clmrs/pages/clmrs-record-detail-page'), 'ClmrsRecordDetailPage'); // prettier-ignore
const VslaPage = lazyRoute(() => import('./features/vsla/pages/vsla-page'), 'VslaPage', '/vsla'); // prettier-ignore
const VslaDetailPage = lazyRoute(() => import('./features/vsla/pages/vsla-detail-page'), 'VslaDetailPage'); // prettier-ignore
const InspectionsPage = lazyRoute(() => import('./features/inspections/pages/inspections-page'), 'InspectionsPage', '/inspections'); // prettier-ignore
const InspectionDetailPage = lazyRoute(() => import('./features/inspections/pages/inspection-detail-page'), 'InspectionDetailPage'); // prettier-ignore
const TrainingPage = lazyRoute(() => import('./features/training/pages/training-page'), 'TrainingPage', '/training'); // prettier-ignore
const TrainingDetailPage = lazyRoute(() => import('./features/training/pages/training-detail-page'), 'TrainingDetailPage'); // prettier-ignore
const CoachingPage = lazyRoute(() => import('./features/coaching/pages/coaching-page'), 'CoachingPage', '/coaching'); // prettier-ignore
const CoachingDetailPage = lazyRoute(() => import('./features/coaching/pages/coaching-detail-page'), 'CoachingDetailPage'); // prettier-ignore
const PurchasePage = lazyRoute(() => import('./features/purchases/pages/purchase-page'), 'PurchasePage', '/purchases'); // prettier-ignore
const PurchaseDetailPage = lazyRoute(() => import('./features/purchases/pages/purchase-detail-page'), 'PurchaseDetailPage'); // prettier-ignore
const PrimaryEvacPage = lazyRoute(() => import('./features/primary-evac/pages/primary-evac-page'), 'PrimaryEvacPage', '/primary-evacuation'); // prettier-ignore
const PrimaryEvacDetailPage = lazyRoute(() => import('./features/primary-evac/pages/primary-evac-detail-page'), 'PrimaryEvacDetailPage'); // prettier-ignore
const TraceabilityPage = lazyRoute(() => import('./features/traceability/pages/traceability-page'), 'TraceabilityPage', '/secondary-evacuation'); // prettier-ignore
const TraceabilityDetailPage = lazyRoute(() => import('./features/traceability/pages/traceability-detail-page'), 'TraceabilityDetailPage'); // prettier-ignore
const ReportsPage = lazyRoute(() => import('./features/reports/pages/reports-page'), 'ReportsPage', '/reports'); // prettier-ignore
const ProfilePage = lazyRoute(() => import('./features/profile/pages/profile-page'), 'ProfilePage', '/profile'); // prettier-ignore
const AdminUsersPage = lazyRoute(() => import('./features/admin/pages/admin-users-page'), 'AdminUsersPage', '/admin/users'); // prettier-ignore
const AdminUserDetailPage = lazyRoute(() => import('./features/admin/pages/admin-user-detail-page'), 'AdminUserDetailPage'); // prettier-ignore
const AdminRolesPage = lazyRoute(() => import('./features/admin/pages/admin-roles-page'), 'AdminRolesPage', '/admin/roles'); // prettier-ignore
const AdminPermissionsPage = lazyRoute(() => import('./features/admin/pages/admin-permissions-page'), 'AdminPermissionsPage', '/admin/permissions'); // prettier-ignore
const AdminCooperativesPage = lazyRoute(() => import('./features/admin/pages/admin-cooperatives-page'), 'AdminCooperativesPage', '/admin/cooperatives'); // prettier-ignore
const AdminCooperativeDetailPage = lazyRoute(() => import('./features/admin/pages/admin-cooperative-detail-page'), 'AdminCooperativeDetailPage'); // prettier-ignore
const AdminSyncPage = lazyRoute(() => import('./features/admin/pages/admin-sync-page'), 'AdminSyncPage', '/admin/sync'); // prettier-ignore
const AdminAuditPage = lazyRoute(() => import('./features/admin/pages/admin-audit-page'), 'AdminAuditPage', '/notifications'); // prettier-ignore
const AdminAuditDetailPage = lazyRoute(() => import('./features/admin/pages/admin-audit-detail-page'), 'AdminAuditDetailPage'); // prettier-ignore
