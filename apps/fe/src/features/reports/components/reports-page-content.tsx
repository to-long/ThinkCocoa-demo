...
const REPORTS: ReportType[] = [
  {
    ...
    filename: 'KuanaData_Certification_Status_Report',
    icon: BadgeCheck,
    description:
  ...
  },
  {
    ...
    filename: 'KuanaData_Corrective_Actions_Report',
    icon: ClipboardList,
    description:
  ...
  },
  {
    ...
    shortLabel: 'EUDR',
    filename: 'KuanaData_EUDR_Compliance_Report',
    icon: ShieldCheck,
    description:
  ...
  },
  {
    ...
    filename: 'KuanaData_Farmer_Coaching_Report_v3',
    icon: GraduationCap,
    description:
  ...
  },
  {
    ...
    title: 'GMR Template',
    shortLabel: 'GMR',
    filename: 'KuanaData_GMR_Template',
  ...
  },
  {
    ...
    filename: 'KuanaData_Traceability_Report_Template',
    icon: RouteIcon,
    description:
  ...
  },
  {
    ...
    shortLabel: 'Training',
    filename: 'KuanaData_Training_Attendance_Report',
    icon: GraduationCap,
    description:
