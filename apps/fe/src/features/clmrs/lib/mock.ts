...
export const MOCK_FLAGS: ClmrsFlag[] = [
  seedFlag({
    ...
    cooperativeName: 'Sankofa Cocoa Cooperative',
  ...
  seedFlag({
    ...
    cooperativeName: 'Nkabom Farmers Cooperative',
  ...
  seedFlag({
    ...
    cooperativeName: 'Aboma Cocoa Cooperative',
...
export const MOCK_CASES: ClmrsCase[] = [
  {
    ...
    createdByName: 'Field Officer — Nkabom Farmers Cooperative',
  },
  {
    id: 'case-02',
  ...
  },
  {
    ...
    createdByName: 'Field Officer — Sankofa Cocoa Cooperative',
  },
];
