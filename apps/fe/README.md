...
## Overview
This is a modern React 19 frontend application built with TypeScript, Tailwind CSS, and Rsbuild. It serves as a landing page for the CocoaImpact project.
...
<script defer src="https://cocoaimpact.creativext.com/inject-web-component.js"></script>
```
