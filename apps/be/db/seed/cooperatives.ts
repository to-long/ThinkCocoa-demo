...
export const DEMO_COOPERATIVES: SeedCooperative[] = [
  {
    ...
    contactEmail: 'sankofa@demo-cocoa.com',
    contactPhone: '+1 30 100 0001',
    address: 'Sankofa Town, Western Zone',
  },
  {
    code: 'NKABOM',
    name: 'Nkabom Farmers',
    ...
    contactEmail: 'nkabom@demo-cocoa.com',
    contactPhone: '+1 31 100 0002',
    address: 'Nkabom Town, Central Zone',
  },
  {
    code: 'ADWUMA',
    ...
    contactEmail: 'adwuma@demo-cocoa.com',
    contactPhone: '+1 32 100 0003',
    address: 'Adwuma Town, Eastern Zone',
  },
  {
    code: 'ABOMA',
    name: 'Aboma Cocoa',
    ...
    contactEmail: 'aboma@demo-cocoa.com',
    contactPhone: '+1 33 100 0004',
    address: 'Aboma Town, Southern Zone',
  },
  {
    code: 'AYEKOO',
    name: 'Ayekoo Cocoa',
    ...
    contactEmail: 'ayekoo@demo-cocoa.com',
    contactPhone: '+1 34 100 0005',
    address: 'Ayekoo Town, Northern Zone',
  },
  {
    code: 'NHYIRA',
    name: 'Nhyira Farmers',
    ...
    contactEmail: 'nhyira@demo-cocoa.com',
    contactPhone: '+1 35 100 0006',
    address: 'Nhyira Town, Volta Zone',
  },
];
